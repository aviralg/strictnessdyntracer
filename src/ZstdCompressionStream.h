#ifndef STRICTNESSDYNTRACER_ZSTD_COMPRESSION_STREAM_H
#define STRICTNESSDYNTRACER_ZSTD_COMPRESSION_STREAM_H
...
#endif /* STRICTNESSDYNTRACER_ZSTD_COMPRESSION_STREAM_H */
