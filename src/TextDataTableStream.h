#ifndef STRICTNESSDYNTRACER_TEXT_DATA_TABLE_STREAM_H
#define STRICTNESSDYNTRACER_TEXT_DATA_TABLE_STREAM_H
...
#endif /* STRICTNESSDYNTRACER_TEXT_DATA_TABLE_STREAM_H */
