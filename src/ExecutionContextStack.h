#ifndef STRICTNESSDYNTRACER_EXECUTION_CONTEXT_STACK_H
#define STRICTNESSDYNTRACER_EXECUTION_CONTEXT_STACK_H
...
#endif /* STRICTNESSDYNTRACER_EXECUTION_CONTEXT_STACK_H */
