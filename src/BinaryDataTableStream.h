#ifndef STRICTNESSDYNTRACER_BINARY_DATA_TABLE_STREAM_H
#define STRICTNESSDYNTRACER_BINARY_DATA_TABLE_STREAM_H
...
#endif /* STRICTNESSDYNTRACER_BINARY_DATA_TABLE_STREAM_H */
