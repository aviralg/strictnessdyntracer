#ifndef STRICTNESSDYNTRACER_PROMISE_LIFECYCLE_SUMMARY_H
#define STRICTNESSDYNTRACER_PROMISE_LIFECYCLE_SUMMARY_H
...
#endif /* STRICTNESSDYNTRACER_PROMISE_LIFECYCLE_SUMMARY_H */
